...
{ An extract of library routines to enable VCLToFireMonkeyFormConvtr
  to compile and run It has been a cut and paste call me if you find bits missing }
...
begin
  ...
  Result := ShellExecuteA(0, // handle to parent window
    PAnsiChar(lpOperation), // pointer to string that specifies operation to perform
    ...
    PAnsiChar(lpDirectory), // pointer to string that specifies default directory
